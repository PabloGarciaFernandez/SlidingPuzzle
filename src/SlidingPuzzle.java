...
public class SlidingPuzzle {
			...
			//for(int i=0;i<tiles.length;i++){
				//for(int j=0;j<tiles.length;j++) {
					if (tiles[1][0]==0||tiles[2][0]==0) {
						if(tiles[i1+1][j1]==tiles[i2][j2]||tiles[i1-1][j1]==tiles[i2][j2]||tiles[i1][j1+1]==tiles[i2][j2]) {	
							aux=tiles[i2][j2];
						...
						if(tiles[i1-1][j1]==tiles[i2][j2]||tiles[i1][j1+1]==tiles[i2][j2]) {	
							aux=tiles[i2][j2];
							tiles[i2][j2]=tiles[i1][j1];
							tiles[i1][j1]=aux;
						}
						...
						if(tiles[i1][j1-1]==tiles[i2][j2]||tiles[i1-1][j1]==tiles[i2][j2]) {
							aux=tiles[i2][j2];
							tiles[i2][j2]=tiles[i1][j1];
							tiles[i1][j1]=aux;
						}
					...
					else if (tiles[1][1]==0 ||tiles[1][2]==0||tiles[2][1]==0||tiles[2][2]==0) {
						if(tiles[i1+1][j1]==tiles[i2][j2]||tiles[i1-1][j1]==tiles[i2][j2]||tiles[i1][j1-1]==tiles[i2][j2]||tiles[i1][j1+1]==tiles[i2][j2]) {	
							aux=tiles[i2][j2];
							tiles[i2][j2]=tiles[i1][j1];
							tiles[i1][j1]=aux;
						}	
						...
						if(tiles[i1+1][j1]==tiles[i2][j2]||tiles[i1][j1+1]==tiles[i2][j2]||tiles[i1][j1-1]==tiles[i2][j2]) {
							aux=tiles[i2][j2];
							tiles[i2][j2]=tiles[i1][j1];
							tiles[i1][j1]=aux;
						}
						...
						if(tiles[i1][j1+1]==tiles[i2][j2]||tiles[i1][j1-1]==tiles[i2][j2]||tiles[i1-1][j1]==tiles[i2][j2]) {
							aux=tiles[i2][j2];
							tiles[i2][j2]=tiles[i1][j1];
							tiles[i1][j1]=aux;
						}
	...
	public static boolean win(int[][]tiles) {
		if(tiles[0][0]==1 && tiles[0][1]==2 && tiles[0][2]==3 && tiles[0][3]==4
				&& tiles[1][0]==5 && tiles[1][1]==6 && tiles[1][2]==7 && tiles[1][3]==8
				&& tiles[2][0]==9 && tiles[2][1]==10 && tiles[2][2]==11 && tiles[2][3]==12
				&&tiles[3][0]==13 && tiles[3][1]==14 && tiles[3][2]==15 && tiles[3][3]==0) {
			return true;
		}
		return false;
	}
	...
	private void start(int [][]tiles,int movements[]) {
		...
		do {
		String num_string = JOptionPane.showInputDialog("Give me an integer: ");
